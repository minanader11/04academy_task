...
class CustomGridViewForClassRoomTexts extends StatelessWidget {
  CustomGridViewForClassRoomTexts({super.key,required this.texts});
  List<String> texts;
  @override
  Widget build(BuildContext context) {
    ...
    CustomTextContainer(text: texts[i],onTap: () {
         stepPageCubit.changeClassRoomIndexText(i);
        },isSelected: stepPageCubit.selectedClassRoom==i,),
        SizedBox(width: 20.w,),
      ]
    ],);
  }
